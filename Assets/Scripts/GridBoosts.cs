...
public class GridBoosts : MonoBehaviour
{
    ...
    public static GridBoosts Instance { get; private set; }
    ...
    void InitGrid()
    {
        ...
        for (int row = 0; row < GridDimension; row++)
            for (int column = 0; column < GridDimension; column++)
            {
                ...
                List<Sprite> possibleSprites = new List<Sprite>(BoostSprites);
        ...
        for (int column = 0; column < GridDimension; column++)
            for (int row = 0; row < GridDimension; row++)
            {
                while (GetSpriteRendererAt(column, row).sprite == null)
                {
                    ...
                    next.sprite = BoostSprites[Random.Range(0, BoostSprites.Count)];
                }
            }
    }
